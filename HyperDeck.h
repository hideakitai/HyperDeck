...
namespace arx { namespace hyperdeck {
...
public:
    ...
    void preview(const bool b) {
        if (b) tcp.println("preview: enable: true");
        else   tcp.println("preview: enable: false");
    }
    ...
    void play_loop(const bool b) {
        if (b) tcp.println("play: loop: true");
        else   tcp.println("play: loop: false");
    }

    void play_single_clip(const bool b) {
        if (b) tcp.println("play: single clip: true");
        else   tcp.println("play: single clip: false");
    }
    ...
    void play_on_startup(const bool b) {
        if (b) tcp.println("play on startup: enable true");
        else   tcp.println("play on startup: enable false");
    }

    void play_on_startup_single_clip(const bool b) {
        if (b) tcp.println("play on startup: single clip: true");
        else   tcp.println("play on startup: single clip: false");
    }
    ...
    void notify_remote(const bool b) {
        if (b) tcp.println("notify: remote: true");
        else   tcp.println("notify: remote: false");
    }

    void notify_transport(const bool b) {
        if (b) tcp.println("notify: transport: true");
        else   tcp.println("notify: transport: false");
    }

    void notify_slot(const bool b) {
        if (b) tcp.println("notify: slot: true");
        else   tcp.println("notify: slot: false");
    }

    void notify_configuration(const bool b) {
        if (b) tcp.println("notify: configuration: true");
        else   tcp.println("notify: configuration: false");
    }

    void notify_drop_frames(const bool b) {
        if (b) tcp.println("notify: dropped frames: true");
        else   tcp.println("notify: dropped frames: false");
    }

    void notify_display_timecode(const bool b) {
        if (b) tcp.println("notify: display timecode: true");
        else   tcp.println("notify: display timecode: false");
    }

    void notify_timeline_position(const bool b) {
        if (b) tcp.println("notify: timeline position: true");
        else   tcp.println("notify: timeline position: false");
    }

    void notify_playrange(const bool b) {
        if (b) tcp.println("notify: playrange: true");
        else   tcp.println("notify: playrange: false");
    }

    void notify_dynamic_range(const bool b) {
        if (b) tcp.println("notify: dynamic range: true");
        else   tcp.println("notify: dynamic range: false");
    }
    ...
    void remote(const bool b) {
        if (b) tcp.println("remote: enable: true");
        else   tcp.println("remote: enable: false");
    }

    void remote_override(const bool b) {
        if (b) tcp.println("remote: override: true");
        else   tcp.println("remote: override: false");
    }
    ...
    void config_append_timestamp(const bool b) {
        if (b) tcp.println("configuration: append timestamp: true");
        else   tcp.println("configuration: append timestamp: false");
    }
    ...
    void identify(const bool b) {
        if (b) tcp.println("identify: enable: true");
        else   tcp.println("identify: enable: false");
    }
